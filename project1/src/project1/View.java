...
public class View {
	...
	public static void render(String gameState, Integer[][] grid, int movesMade, String moveStatus, char lastKeyPressed) throws Exception {
		clear();
		...
		switch (gameState) {
		case "won":
			System.out.println("last move WON THE GAME!");
			System.out.println("keys: (r)estart, (q)uit");
			System.out.println();
			break;
		case "lost":
			System.out.println("last move lost the game :(");
			System.out.println("keys: (r)estart, (q)uit");
			System.out.println();
			break;
		case "in_progress":
